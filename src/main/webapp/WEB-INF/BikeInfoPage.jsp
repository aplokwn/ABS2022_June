                    ...
                    <div class="panel-body">
                        <form method="post" action="BikeInventory" role="form product-form">
                            <div class="form-group">
                                <h3>By Price:</h3>
                                <input type="text" id="minPrice" name="minPrice" min="0" placeholder="min price"
                                       class="form-control"/>
                    ...
                    <c:when test="${emptyjson eq 'false'}">
                        <div class="row product-list">
                            ...
                            <form method="POST" action="BikeInventory">
                                ...
                                <input type="submit" class="btn btn-success btn-lg" name="prePage"
                                       value="Previous Page"/>
