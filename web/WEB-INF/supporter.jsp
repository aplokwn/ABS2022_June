...
<div class="container">
    ...
    <div class="row row-cols-sm-3 g-5 inline-row">
        ...
        <div class="supporters-box">
            <div class="col card shadow">
                <div class="supporters-img" style="background-image: url('assets/img/supporters/Bike-Index.jpg')"></div>
    ...
    <div class="row row-cols-sm-4 g-4 inline-row">
        ...
        <div class="supporters-box">
            <div class="col card shadow">
                <div class="supporters-img" style="background-image: url('assets/img/supporters/Bow_CycleBow_Cycle.png')"></div>
