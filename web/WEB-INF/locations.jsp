...
<html lang="en">
    ...
    <body>
        ...
        <c:set var = "cityId" scope = "session" value = "${cityId}"/>
                    ...
                    <form action="${path}/locations" name="city" method="POST">
                        ...
                        <div class="container city-row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm"><h4 id="address"> ${location}</h4></div>
                            <div class="w-100"></div>
        ...
        <div class="container-md addon" >
            <div class="row">
                <div class="col text-center" >
                    <button type="button" class="btn btn-info" id="goFaq" onclick="window.location.href = '/Faq'">Want to know more?</button>
                    <button type="button" class="btn btn-info" id="goFaq" onclick="locationsApp.genPDF()">Download Poster</button>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <iframe class="responsive-iframe" src="https://www.youtube.com/embed/ZntnXr1p2p0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
